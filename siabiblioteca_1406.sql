...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 15-Jun-2019 às 01:37
...
INSERT INTO `emprestimo` (`CodEmprestimo`, `CodLivroDidatico`, `RM`, `DataEmprestimo`) VALUES
(1, 2, 14119, '2019-06-14'),
(2, 3, 14120, '2019-06-14');
...
INSERT INTO `livrodidatico` (`CodLivroDidatico`, `CodCategoria`, `Volume`, `Ano`, `Editora`, `Status`, `CodigoBarra`) VALUES
(1, 1, 1, 2029, 'Livraria', 0, 'MATVOL100001');
COMMIT;
