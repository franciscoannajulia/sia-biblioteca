...
<div class="wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>CÓDIGO</label>
                                                <input type="text" class="form-control" placeholder=" SCANEAR CÓDIGO DE BARRAS" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>DATA</label>
                                                <input type="date" class="form-control" placeholder="SCANEAR CÓDIGO DE BARRAS" >
                                            </div>
                                        </div>
                                    </div>
                                    

                                    <button type="submit" class="btn btn-info btn-fill pull-right">Devolver Livro</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'fas fa-robot',
                message: "Nesta página você pode fazer a devolução do livro."
